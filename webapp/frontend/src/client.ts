// Code generated by the Encore v1.46.19 client generator. DO NOT EDIT.
...
export namespace webapp {
  export class ServiceClient {
    ...
    public async Login(
      ...
      return this.baseClient.callAPI(method, `/app/login`, body, options)
    }
    ...
    public async Register(
      ...
      return this.baseClient.callAPI(method, `/app/register`, body, options)
    }
  }
}
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof globalThis === 'object' && !('window' in globalThis)) {
      this.headers['User-Agent'] = 'o3g5s-Generated-TS-Client (Encore/v1.46.19)'
    }
